...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "IdeaBox — every idea in one playful box" },
      { name: "description", content: "Toss in ideas, triage in the box, ship the best ones." },
      { name: "author", content: "IdeaBox" },
      { property: "og:title", content: "IdeaBox" },
      { property: "og:description", content: "Every idea in one playful box." },
